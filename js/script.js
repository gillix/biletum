...
const langArr = {
	...
	"menu__list":{
		"ru": ['Biletium', 'Услуги', 'Партнеры', 'Преимущества', 'Команда','Контакты'],
		"en": ['Biletium', 'Services', 'Partners', 'Advantages', 'Team', 'Contacts'],
		"ua": ['Biletium', 'Послуги', 'Партнери', 'Переваги', 'Команда', 'Контакти']
	},
	"btn-sale":{
  ...
  "slider__text3":{
		...
		"ua": ['Платформи для проведення заходів', ' інтеграція з 5 платформами для будь-якого формату проведення заходів', 'повна автоматизація передавання даних з платформами', 'автоматичне створення мобільного застосунку заходу']
	},
  "skills__list":{
  ...
  "team-card8":{
    "ru": ['Эмма Джанг', 'Business Development Manager (Asia)'],
		...
		"ua": ['Емма Джанг', 'Business Development Manager (Asia)']
  },
  "footer__item1":{
  ...
  "footer__item3":{
    "ru": ['Китай,', 'Шанхай,<br>р-н. 2115, 21F, East Ocean Centre Phase, № 618 East Yan An Road'],
		...
		"ua": ['Китай,', 'Шанхай,<br>обл. 2115, 21F, East Ocean Ctntre Phase, №.618 East Yan An Road']
  },
  "footer__item4":{
